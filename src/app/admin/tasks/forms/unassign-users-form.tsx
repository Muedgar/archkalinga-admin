...
import { getTask, getUsers, unAssignUsersTask } from '@/store/thunks'
...
const UnAssignUsersTaskForm = () => {
  ...
  const onSubmit = async (data: AssignUsersTaskFormValues) => {
    await dispatch(unAssignUsersTask({ id: `${id}`, params: { ...data } }))
      .unwrap()
      .then(() => {
        toast.success('Unassigned Users From Task Successfully')
...
export default UnAssignUsersTaskForm
