  ...
  return (
    <AdminPanelLayout>
      ...
      <TabsList className="grid w-full grid-cols-2">
        <TabsTrigger onClick={() => setCurrentTab('shell_template')} value="shell_template">Shell Schedule Template</TabsTrigger>
        <TabsTrigger onClick={() => setCurrentTab('shell_quantities')} value="shell_quantities">Shell Schedule & Quantities</TabsTrigger>
      </TabsList>
