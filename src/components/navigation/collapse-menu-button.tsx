...
export function CollapseMenuButton({
  ...
  const isSubmenuActive = submenus.some((submenu) =>
    submenu.active == undefined
      ? submenu.href === pathname // Changed from location.pathname
      : submenu.active
  )
      ...
      <CollapsibleContent className="overflow-hidden data-[state=closed]:animate-collapsible-up data-[state=open]:animate-collapsible-down">
        {submenus.map(({ href, label, active }, index) => (
          <Button
            key={index}
            variant={
              (active === undefined && pathname === href) || active // Changed from location.pathname
                ? 'secondary'
                : 'ghost'
            }
          ...
          >
            <Link href={href}>
              {' '}
              {/* Changed from to={href} to href={href} */}
        ...
        {submenus.map(({ href, label, active }, index) => (
          <DropdownMenuItem key={index} asChild>
            ...
            prefetch={true}
              ...
              href={href} // Changed from to={href} to href={href}
            >
