    ...
    return (
      <div className="w-full flex justify-center items-center mt-32">
        <p className="flex items-center gap-2 text-muted-foreground">
          Fetching Shell Quantity Details{' '}
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-xl flex items-center gap-2">
            <DrillIcon className="w-5 h-5 text-primary" /> Shell Quantity
            Details
          </CardTitle>
        </CardHeader>
        <Separator />
        <CardContent className="space-y-6 pt-6">
          ...
          {itemTaskQuantity?.length ? (
              ...
              <Card key={entry.id} className="p-4 bg-muted/20">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <InfoRowLink
                    ...
                    url={`/admin/shell/view/${entry.item?.id}`}
                  />
                  <InfoRow
                  ...
                  <InfoRowLink
                    ...
                    url={`/admin/tasks/view/${entry.item?.id}`}
                  />
                </div>
              </Card>
            ))
            ...
            <p className="text-muted-foreground italic">
              No item-task quantities available.
            </p>
          )}
        </CardContent>
      </Card>
